  ...
  function getCryptoData() {
    fetch(
      ...
      .then((data) => {
        ...
        console.log(cryptoData[0].current_price);
        console.log(cryptoData[1].current_price);
        console.log(cryptoData[3].current_price);
    ...
    cryptoPriceData.map((values) => {
      ...
      data += `
        ...
        2
          ...
          <td class="table__t-a-r p-16 hide">$${formattedVolume24}</td>
          <td class="table__t-a-r p-16 hide">$${formattedMarketCap}</td>
        </tr>
        `;
    });
